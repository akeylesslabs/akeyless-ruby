...
module Akeyless
  ...
  class TargetUpdateWindows
    ...
    def hash
      [certificate, connection_type, delete_protection, description, domain, hostname, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_name, parent_target_name, password, port, rotate_on_unlock, token, uid_token, use_tls, username].hash
    end
