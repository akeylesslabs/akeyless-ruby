...
module Akeyless
  ...
  class DynamicSecretUpdateRedis
    ...
    def hash
      [acl_rules, custom_username_template, delete_protection, description, host, input_rule, item_custom_fields, json, name, new_name, output_rule, password, password_length, port, producer_encryption_key_name, ssl, ssl_certificate, tags, target_name, token, uid_token, use_capital_letters, use_lower_letters, use_numbers, use_special_characters, user_ttl, username].hash
    end
