...
module Akeyless
  ...
  class TargetCreateLdap
    ...
    def hash
      [bind_dn, bind_dn_password, delete_protection, description, json, key, ldap_ca_cert, ldap_url, lock_on_read, lock_ttl, max_versions, name, rotate_on_unlock, server_type, token, token_expiration, uid_token].hash
    end
