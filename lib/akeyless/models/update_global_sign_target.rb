...
module Akeyless
  ...
  class UpdateGlobalSignTarget
    ...
    def hash
      [comment, contact_email, contact_first_name, contact_last_name, contact_phone, description, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_name, password, profile_id, rotate_on_unlock, timeout, token, uid_token, update_version, username].hash
    end
