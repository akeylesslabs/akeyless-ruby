...
module Akeyless
  ...
  class UpdateNativeK8STarget
    ...
    def hash
      [comment, description, json, k8s_auth_type, k8s_client_certificate, k8s_client_key, k8s_cluster_ca_cert, k8s_cluster_endpoint, k8s_cluster_name, k8s_cluster_token, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_name, rotate_on_unlock, token, uid_token, update_version, use_gw_service_account].hash
    end
