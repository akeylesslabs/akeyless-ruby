...
module Akeyless
  ...
  class CreateNativeK8STarget
    ...
    def hash
      [comment, description, json, k8s_auth_type, k8s_client_certificate, k8s_client_key, k8s_cluster_ca_cert, k8s_cluster_endpoint, k8s_cluster_name, k8s_cluster_token, key, lock_on_read, lock_ttl, max_versions, name, rotate_on_unlock, token, uid_token, use_gw_service_account].hash
    end
