...
module Akeyless
  class TargetUpdateAerospike
    ...
    def hash
      [admin_username, aerospike_client_id, aerospike_client_secret, aerospike_cloud, aerospike_cluster_id, client_certificate, client_private_key, db_server_name, delete_protection, description, enable_mtls, hostname, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, namespace, new_comment, new_name, password, port, rotate_on_unlock, skip_server_name_validation, ssl, ssl_certificate, token, uid_token].hash
    end
