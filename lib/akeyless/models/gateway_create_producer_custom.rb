...
module Akeyless
  ...
  class GatewayCreateProducerCustom
    ...
    def hash
      [admin_rotation_interval_days, ara_enabled, create_sync_url, delete_protection, enable_admin_rotation, input_rule, item_custom_fields, json, name, output_rule, payload, producer_encryption_key_name, revoke_sync_url, rotate_sync_url, skip_dry_run, tags, timeout_sec, token, uid_token, user_ttl].hash
    end
