...
module Akeyless
  ...
  class DynamicSecretUpdateDockerhub
    ...
    def hash
      [ara_enabled, delete_protection, description, dockerhub_password, dockerhub_token_scopes, dockerhub_username, enable_agentic_runtime_authority, enable_ai_quorum, input_rule, item_custom_fields, json, name, new_name, output_rule, producer_encryption_key_name, skip_dry_run, tags, target_name, token, uid_token, user_ttl].hash
    end
