...
module Akeyless
  ...
  class CreateAWSTarget
    ...
    def hash
      [access_key, access_key_id, comment, description, generate_external_id, json, key, lock_on_read, lock_ttl, max_versions, name, region, role_arn, rotate_on_unlock, session_token, token, uid_token, use_gw_cloud_identity].hash
    end
