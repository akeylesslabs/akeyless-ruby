...
module Akeyless
  ...
  class CreatePingTarget
    ...
    def hash
      [administrative_port, authorization_port, comment, description, json, key, lock_on_read, lock_ttl, max_versions, name, password, ping_url, privileged_user, rotate_on_unlock, token, uid_token].hash
    end
