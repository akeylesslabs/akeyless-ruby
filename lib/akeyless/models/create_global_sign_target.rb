...
module Akeyless
  ...
  class CreateGlobalSignTarget
    ...
    def hash
      [comment, contact_email, contact_first_name, contact_last_name, contact_phone, description, json, key, lock_on_read, lock_ttl, max_versions, name, password, profile_id, rotate_on_unlock, timeout, token, uid_token, username].hash
    end
