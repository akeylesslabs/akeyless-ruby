...
module Akeyless
  class RotatedSecretUpdateAzure
    ...
    def hash
      [add_tag, api_id, api_key, application_id, ara_enabled, authentication_credentials, auto_rotate, delete_protection, description, enable_agentic_runtime_authority, enable_ai_quorum, explicitly_set_sa, grace_rotation, grace_rotation_hour, grace_rotation_interval, grace_rotation_timing, input_rule, item_custom_fields, json, keep_prev_version, key, lock_during_sra_session, lock_on_read, lock_ttl, max_versions, name, new_name, output_rule, password, password_length, resource_group_name, resource_name, rm_tag, rotate_after_disconnect, rotate_on_unlock, rotation_event_in, rotation_hour, rotation_interval, secure_access_disable_concurrent_connections, secure_access_enable, secure_access_url, secure_access_web, secure_access_web_browsing, secure_access_web_proxy, skip_dry_run, storage_account_key_name, token, uid_token, use_capital_letters, use_lower_letters, use_numbers, use_special_characters, username].hash
    end
