...
module Akeyless
  ...
  class AuthMethodUpdateAliCloud
    ...
    attr_accessor :bound_account_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Akeyless::AuthMethodUpdateAliCloud` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Akeyless::AuthMethodUpdateAliCloud`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'bound_account_id')
        if (value = attributes[:'bound_account_id']).is_a?(Array)
          self.bound_account_id = value
        end
      end
      ...
      if attributes.key?(:'sts_url')
        ...
        self.sts_url = 'https://sts.aliyuncs.com'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bound_account_id == o.bound_account_id &&
    ...
    def hash
      [access_expires, allowed_client_type, audit_logs_claims, bound_account_id, bound_arn, bound_ips, bound_resource_id, bound_role_id, bound_role_name, bound_user_id, bound_user_name, delete_protection, description, expiration_event_in, force_sub_claims, gw_bound_ips, json, jwt_ttl, name, new_name, product_type, sts_url, token, uid_token, unique_identifier].hash
    end
