...
module Akeyless
  ...
  class DynamicSecretUpdateGke
    ...
    def hash
      [delete_protection, description, gke_account_key, gke_cluster_cert, gke_cluster_endpoint, gke_cluster_name, gke_service_account_email, input_rule, item_custom_fields, json, name, new_name, output_rule, producer_encryption_key_name, secure_access_allow_port_forwading, secure_access_bastion_issuer, secure_access_certificate_issuer, secure_access_cluster_endpoint, secure_access_delay, secure_access_enable, secure_access_web, tags, target_name, token, uid_token, user_ttl].hash
    end
