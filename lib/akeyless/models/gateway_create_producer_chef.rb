...
module Akeyless
  ...
  class GatewayCreateProducerChef
    ...
    def hash
      [ara_enabled, chef_orgs, chef_server_key, chef_server_url, chef_server_username, custom_username_template, delete_protection, enable_agentic_runtime_authority, enable_ai_quorum, input_rule, item_custom_fields, json, name, output_rule, password_length, producer_encryption_key_name, skip_dry_run, skip_ssl, tags, target_name, token, uid_token, use_capital_letters, use_lower_letters, use_numbers, use_special_characters, user_ttl].hash
    end
