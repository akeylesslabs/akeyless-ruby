  ...
  class TargetUpdateCustomDns
    ...
    def self.openapi_types
      {
        ...
        :'description' => :'String',
        :'dns_parameter' => :'Hash<String, String>',
        :'json' => :'Boolean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Akeyless::TargetUpdateCustomDns` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Akeyless::TargetUpdateCustomDns`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'dns_parameter')
        if (value = attributes[:'dns_parameter']).is_a?(Hash)
          self.dns_parameter = value
        end
      else
        self.dns_parameter = nil
      end
    ...
    def list_invalid_properties
      ...
      if @dns_parameter.nil?
        invalid_properties.push('invalid value for "dns_parameter", dns_parameter cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @dns_parameter.nil?
    ...
    def hash
      [delete_protection, description, dns_parameter, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_name, provider_type, rotate_on_unlock, token, uid_token].hash
    end
