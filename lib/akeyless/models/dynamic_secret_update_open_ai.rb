...
module Akeyless
  ...
  class DynamicSecretUpdateOpenAI
    ...
    def hash
      [ara_enabled, custom_username_template, delete_protection, description, enable_agentic_runtime_authority, enable_ai_quorum, input_rule, item_custom_fields, json, name, new_name, output_rule, producer_encryption_key_name, project_id, skip_dry_run, tags, target_name, token, uid_token, user_ttl].hash
    end
