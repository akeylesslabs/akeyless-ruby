...
module Akeyless
  class UpdateRole
    ...
    def hash
      [analytics_access, approve_access_request, ara_reports_access, audit_access, delete_protection, description, event_center_access, event_forwarder_access, gw_analytics_access, isi_access, json, name, new_comment, new_name, reverse_rbac_access, sra_reports_access, token, uid_token, unlock_secrets, usage_reports_access].hash
    end
