...
module Akeyless
  ...
  class CreateRabbitMQTarget
    ...
    def hash
      [comment, description, json, key, lock_on_read, lock_ttl, max_versions, name, rabbitmq_server_password, rabbitmq_server_uri, rabbitmq_server_user, rotate_on_unlock, token, uid_token].hash
    end
