...
module Akeyless
  ...
  class RotatedSecretCreateOpenAI
    ...
    def hash
      [api_key, api_key_id, authentication_credentials, auto_rotate, delete_protection, description, input_rule, item_custom_fields, json, key, max_versions, name, output_rule, password_length, rotation_event_in, rotation_hour, rotation_interval, rotator_type, tags, target_name, token, uid_token].hash
    end
