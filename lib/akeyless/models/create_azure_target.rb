...
module Akeyless
  ...
  class CreateAzureTarget
    ...
    def hash
      [azure_cloud, client_id, client_secret, comment, connection_type, description, json, key, lock_on_read, lock_ttl, max_versions, name, resource_group_name, resource_name, rotate_on_unlock, subscription_id, tenant_id, token, uid_token, use_gw_cloud_identity].hash
    end
