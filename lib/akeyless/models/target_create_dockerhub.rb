...
module Akeyless
  class TargetCreateDockerhub
    ...
    def hash
      [delete_protection, description, dockerhub_password, dockerhub_username, json, key, lock_on_read, lock_ttl, max_versions, name, rotate_on_unlock, token, uid_token].hash
    end
