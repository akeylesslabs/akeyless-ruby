...
module Akeyless
  ...
  class GatewayUpdateProducerGithub
    ...
    def hash
      [delete_protection, github_app_id, github_app_private_key, github_base_url, input_rule, installation_id, installation_organization, installation_repository, item_custom_fields, json, name, new_name, output_rule, tags, target_name, token, token_permissions, token_repositories, token_ttl, uid_token].hash
    end
