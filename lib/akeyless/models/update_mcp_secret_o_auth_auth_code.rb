...
module Akeyless
  class UpdateMcpSecretOAuthAuthCode
    ...
    def hash
      [accessibility, ara_enabled, enable_agentic_runtime_authority, enable_ai_quorum, input_rule, json, keep_prev_version, key, last_version, name, oauth_client_id, oauth_client_secret, oauth_redirect_uri, oauth_refresh_token, oauth_scopes, oauth_token_url, output_rule, token, uid_token, url].hash
    end
