...
module Akeyless
  ...
  class DynamicSecretUpdateGoogleWorkspace
    ...
    def hash
      [access_mode, admin_email, ara_enabled, delete_protection, description, enable_agentic_runtime_authority, enable_ai_quorum, fixed_user_claim_keyname, gcp_key, group_email, group_role, input_rule, item_custom_fields, json, name, new_name, output_rule, producer_encryption_key_name, role_name, role_scope, secure_access_delay, secure_access_enable, secure_access_url, secure_access_web, secure_access_web_browsing, secure_access_web_proxy, skip_dry_run, tags, target_name, token, uid_token, user_ttl].hash
    end
