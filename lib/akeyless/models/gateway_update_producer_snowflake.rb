...
module Akeyless
  ...
  class GatewayUpdateProducerSnowflake
    ...
    def hash
      [account, account_password, account_username, ara_enabled, auth_mode, custom_username_template, db_name, delete_protection, enable_agentic_runtime_authority, enable_ai_quorum, input_rule, item_custom_fields, json, key_algo, name, new_name, output_rule, password_length, private_key, private_key_passphrase, role, skip_dry_run, tags, target_name, token, uid_token, use_capital_letters, use_lower_letters, use_numbers, use_special_characters, user_ttl, warehouse].hash
    end
