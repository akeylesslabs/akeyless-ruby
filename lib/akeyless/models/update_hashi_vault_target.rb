...
module Akeyless
  ...
  class UpdateHashiVaultTarget
    ...
    def hash
      [description, hashi_url, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, namespace, new_name, rotate_on_unlock, token, uid_token, update_version, vault_token].hash
    end
