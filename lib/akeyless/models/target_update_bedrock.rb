...
module Akeyless
  ...
  class TargetUpdateBedrock
    ...
    def hash
      [api_key, bedrock_url, delete_protection, description, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_comment, new_name, rotate_on_unlock, token, uid_token].hash
    end
