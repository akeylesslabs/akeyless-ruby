...
module Akeyless
  ...
  class DynamicSecretUpdateSnowflake
    ...
    def hash
      [account, account_password, account_username, auth_mode, custom_username_template, db_name, delete_protection, description, input_rule, item_custom_fields, json, key_algo, name, new_name, output_rule, password_length, private_key, private_key_passphrase, role, tags, target_name, token, uid_token, user_ttl, warehouse].hash
    end
