...
module Akeyless
  ...
  class DynamicSecretUpdateArtifactory
    ...
    def hash
      [ara_enabled, artifactory_admin_name, artifactory_admin_pwd, artifactory_token_audience, artifactory_token_scope, base_url, custom_username_template, delete_protection, description, input_rule, item_custom_fields, json, name, new_name, output_rule, producer_encryption_key_name, skip_dry_run, tags, target_name, token, uid_token, user_ttl].hash
    end
