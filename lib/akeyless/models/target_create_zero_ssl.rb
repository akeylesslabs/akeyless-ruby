...
module Akeyless
  ...
  class TargetCreateZeroSSL
    ...
    def hash
      [api_key, delete_protection, description, imap_fqdn, imap_password, imap_port, imap_target_email, imap_username, json, key, lock_on_read, lock_ttl, max_versions, name, rotate_on_unlock, timeout, token, uid_token].hash
    end
