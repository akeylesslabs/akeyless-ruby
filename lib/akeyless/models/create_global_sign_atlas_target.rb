...
module Akeyless
  ...
  class CreateGlobalSignAtlasTarget
    ...
    def hash
      [api_key, api_secret, comment, description, json, key, lock_on_read, lock_ttl, max_versions, mtls_cert_data_base64, mtls_key_data_base64, name, rotate_on_unlock, timeout, token, uid_token].hash
    end
