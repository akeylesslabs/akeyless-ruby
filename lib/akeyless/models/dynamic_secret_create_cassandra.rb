...
module Akeyless
  ...
  class DynamicSecretCreateCassandra
    ...
    def hash
      [ara_enabled, cassandra_creation_statements, cassandra_hosts, cassandra_password, cassandra_port, cassandra_username, custom_username_template, delete_protection, description, input_rule, item_custom_fields, json, name, output_rule, password_length, producer_encryption_key_name, skip_dry_run, ssl, ssl_certificate, tags, target_name, token, uid_token, use_capital_letters, use_lower_letters, use_numbers, use_special_characters, user_ttl].hash
    end
