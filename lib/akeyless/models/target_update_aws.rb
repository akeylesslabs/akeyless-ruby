...
module Akeyless
  class TargetUpdateAws
    ...
    def hash
      [access_key, access_key_id, delete_protection, description, generate_external_id, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_name, region, role_arn, rotate_on_unlock, session_token, token, uid_token, use_gw_cloud_identity].hash
    end
