...
module Akeyless
  class RotatedSecretCreateSsh
    ...
    def hash
      [authentication_credentials, auto_rotate, delete_protection, description, input_rule, item_custom_fields, json, key, key_data_base64, lock_during_sra_session, max_versions, name, output_rule, password_length, public_key_remote_path, rotate_after_disconnect, rotated_password, rotated_username, rotation_event_in, rotation_hour, rotation_interval, rotator_custom_cmd, rotator_type, same_password, secure_access_allow_external_user, secure_access_bastion_issuer, secure_access_certificate_issuer, secure_access_enable, secure_access_host, secure_access_rdp_domain, secure_access_rdp_user, secure_access_ssh_user, secure_access_target_type, tags, target_name, token, uid_token, use_capital_letters, use_lower_letters, use_numbers, use_special_characters].hash
    end
