...
module Akeyless
  ...
  class GatewayCreateProducerDockerhub
    ...
    def hash
      [delete_protection, dockerhub_password, dockerhub_token_scopes, dockerhub_username, input_rule, item_custom_fields, json, name, output_rule, producer_encryption_key_name, tags, target_name, token, uid_token, user_ttl].hash
    end
