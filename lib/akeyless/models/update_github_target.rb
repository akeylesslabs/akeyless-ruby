...
module Akeyless
  ...
  class UpdateGithubTarget
    ...
    def hash
      [comment, description, github_app_id, github_app_private_key, github_base_url, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_name, rotate_on_unlock, token, uid_token, update_version].hash
    end
