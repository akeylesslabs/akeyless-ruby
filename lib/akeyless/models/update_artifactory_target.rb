...
module Akeyless
  ...
  class UpdateArtifactoryTarget
    ...
    def hash
      [artifactory_admin_name, artifactory_admin_pwd, base_url, comment, description, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_name, rotate_on_unlock, token, uid_token, update_version].hash
    end
