...
module Akeyless
  ...
  class UpdateSSHTarget
    ...
    def hash
      [description, host, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_name, port, private_key, private_key_password, rotate_on_unlock, ssh_password, ssh_username, token, uid_token, update_version].hash
    end
