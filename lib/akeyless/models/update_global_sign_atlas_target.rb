...
module Akeyless
  ...
  class UpdateGlobalSignAtlasTarget
    ...
    def hash
      [api_key, api_secret, comment, description, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, mtls_cert_data_base64, mtls_key_data_base64, name, new_name, rotate_on_unlock, timeout, token, uid_token, update_version].hash
    end
