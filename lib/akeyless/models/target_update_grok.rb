...
module Akeyless
  ...
  class TargetUpdateGrok
    ...
    def hash
      [api_key, delete_protection, description, grok_url, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_comment, new_name, rotate_on_unlock, team_id, token, uid_token].hash
    end
