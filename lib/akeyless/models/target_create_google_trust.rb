...
module Akeyless
  ...
  class TargetCreateGoogleTrust
    ...
    def hash
      [acme_challenge, delete_protection, description, dns_target_creds, dns_zone, eab_hmac_key, eab_key_id, email, gcp_project, google_trust_url, hosted_zone, json, key, max_versions, name, resource_group, timeout, token, uid_token].hash
    end
