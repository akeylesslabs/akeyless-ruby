...
module Akeyless
  class TargetUpdateDockerhub
    ...
    def hash
      [delete_protection, description, dockerhub_password, dockerhub_username, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_name, rotate_on_unlock, token, uid_token].hash
    end
