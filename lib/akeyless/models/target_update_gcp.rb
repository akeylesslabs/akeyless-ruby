...
module Akeyless
  class TargetUpdateGcp
    ...
    def hash
      [delete_protection, description, gcp_key, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_name, rotate_on_unlock, token, uid_token, use_gw_cloud_identity].hash
    end
