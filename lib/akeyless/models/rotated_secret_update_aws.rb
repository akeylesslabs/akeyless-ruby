...
module Akeyless
  class RotatedSecretUpdateAws
    ...
    def hash
      [add_tag, api_id, api_key, ara_enabled, authentication_credentials, auto_rotate, aws_region, delete_protection, description, enable_agentic_runtime_authority, enable_ai_quorum, grace_rotation, grace_rotation_hour, grace_rotation_interval, grace_rotation_timing, input_rule, item_custom_fields, json, keep_prev_version, key, lock_during_sra_session, lock_on_read, lock_ttl, max_versions, name, new_name, output_rule, password_length, rm_tag, rotate_after_disconnect, rotate_on_unlock, rotation_event_in, rotation_hour, rotation_interval, secure_access_aws_account_id, secure_access_aws_native_cli, secure_access_bastion_issuer, secure_access_certificate_issuer, secure_access_enable, skip_dry_run, token, uid_token, use_capital_letters, use_lower_letters, use_numbers, use_special_characters].hash
    end
