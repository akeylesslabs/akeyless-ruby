...
module Akeyless
  ...
  class TargetUpdateDigiCert
    ...
    def hash
      [acme_challenge, delete_protection, description, digicert_url, dns_target_creds, dns_zone, eab_hmac_key, eab_key_id, email, gcp_project, hosted_zone, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_name, resource_group, rotate_on_unlock, timeout, token, uid_token].hash
    end
