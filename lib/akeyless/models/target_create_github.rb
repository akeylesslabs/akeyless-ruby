...
module Akeyless
  class TargetCreateGithub
    ...
    def hash
      [delete_protection, description, github_app_id, github_app_private_key, github_base_url, json, key, lock_on_read, lock_ttl, max_versions, name, rotate_on_unlock, token, uid_token].hash
    end
