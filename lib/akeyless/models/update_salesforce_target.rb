...
module Akeyless
  ...
  class UpdateSalesforceTarget
    ...
    def hash
      [app_private_key_data, auth_flow, ca_cert_data, ca_cert_name, client_id, client_secret, comment, description, email, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_name, password, rotate_on_unlock, security_token, tenant_url, token, uid_token, update_version].hash
    end
