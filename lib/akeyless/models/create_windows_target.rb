...
module Akeyless
  ...
  class CreateWindowsTarget
    ...
    def hash
      [certificate, connection_type, description, domain, hostname, json, key, lock_on_read, lock_ttl, max_versions, name, parent_target_name, password, port, rotate_on_unlock, token, uid_token, use_tls, username].hash
    end
