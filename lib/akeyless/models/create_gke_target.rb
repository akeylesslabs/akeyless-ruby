...
module Akeyless
  ...
  class CreateGKETarget
    ...
    def hash
      [comment, description, gke_account_key, gke_cluster_cert, gke_cluster_endpoint, gke_cluster_name, gke_service_account_email, json, key, lock_on_read, lock_ttl, max_versions, name, rotate_on_unlock, token, uid_token, use_gw_cloud_identity].hash
    end
