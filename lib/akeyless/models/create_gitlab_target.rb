...
module Akeyless
  ...
  class CreateGitlabTarget
    ...
    def hash
      [comment, description, gitlab_access_token, gitlab_certificate, gitlab_url, json, key, lock_on_read, lock_ttl, max_versions, name, rotate_on_unlock, token, uid_token].hash
    end
