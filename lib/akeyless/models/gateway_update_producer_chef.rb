...
module Akeyless
  ...
  class GatewayUpdateProducerChef
    ...
    def hash
      [chef_orgs, chef_server_key, chef_server_url, chef_server_username, custom_username_template, delete_protection, input_rule, item_custom_fields, json, name, new_name, output_rule, password_length, producer_encryption_key_name, skip_ssl, tags, target_name, token, uid_token, user_ttl].hash
    end
