...
module Akeyless
  ...
  class UpdateGodaddyTarget
    ...
    def hash
      [api_key, comment, customer_id, description, imap_fqdn, imap_password, imap_port, imap_username, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_name, rotate_on_unlock, secret, timeout, token, uid_token, update_version].hash
    end
