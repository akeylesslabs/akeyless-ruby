...
module Akeyless
  ...
  class CreateEKSTarget
    ...
    def hash
      [comment, description, eks_access_key_id, eks_cluster_ca_cert, eks_cluster_endpoint, eks_cluster_name, eks_region, eks_secret_access_key, json, key, lock_on_read, lock_ttl, max_versions, name, rotate_on_unlock, token, uid_token, use_gw_cloud_identity].hash
    end
