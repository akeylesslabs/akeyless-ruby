...
module Akeyless
  class TargetCreateArtifactory
    ...
    def hash
      [artifactory_admin_name, artifactory_admin_pwd, base_url, delete_protection, description, json, key, lock_on_read, lock_ttl, max_versions, name, rotate_on_unlock, token, uid_token].hash
    end
