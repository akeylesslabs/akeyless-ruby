...
module Akeyless
  class TargetUpdateHashiVault
    ...
    def hash
      [delete_protection, description, hashi_url, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, namespace, new_name, rotate_on_unlock, token, uid_token, vault_token].hash
    end
