...
module Akeyless
  ...
  class DynamicSecretCreateRedshift
    ...
    def hash
      [creation_statements, custom_username_template, delete_protection, description, input_rule, item_custom_fields, json, name, output_rule, password_length, producer_encryption_key, redshift_db_name, redshift_host, redshift_password, redshift_port, redshift_username, secure_access_enable, secure_access_host, ssl, tags, target_name, token, uid_token, user_ttl].hash
    end
