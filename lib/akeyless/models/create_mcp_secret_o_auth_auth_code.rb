...
module Akeyless
  class CreateMcpSecretOAuthAuthCode
    ...
    def hash
      [accessibility, ara_enabled, delete_protection, description, enable_agentic_runtime_authority, enable_ai_quorum, input_rule, json, max_versions, metadata, name, oauth_client_id, oauth_client_secret, oauth_redirect_uri, oauth_refresh_token, oauth_scopes, oauth_token_url, output_rule, protection_key, tags, token, uid_token, url].hash
    end
