...
module Akeyless
  ...
  class CreateZeroSSLTarget
    ...
    def hash
      [api_key, comment, description, imap_fqdn, imap_password, imap_port, imap_target_email, imap_username, json, key, lock_on_read, lock_ttl, max_versions, name, rotate_on_unlock, timeout, token, uid_token].hash
    end
