...
module Akeyless
  ...
  class TargetUpdateGemini
    ...
    def hash
      [api_key, delete_protection, description, gemini_url, json, keep_prev_version, key, lock_on_read, lock_ttl, max_versions, name, new_comment, new_name, rotate_on_unlock, token, uid_token].hash
    end
