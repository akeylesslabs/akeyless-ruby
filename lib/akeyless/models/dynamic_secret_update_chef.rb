...
module Akeyless
  ...
  class DynamicSecretUpdateChef
    ...
    def hash
      [ara_enabled, chef_orgs, chef_server_key, chef_server_url, chef_server_username, custom_username_template, delete_protection, description, enable_agentic_runtime_authority, enable_ai_quorum, input_rule, item_custom_fields, json, name, new_name, output_rule, password_length, producer_encryption_key_name, skip_ssl, skip_dry_run, tags, target_name, token, uid_token, use_capital_letters, use_lower_letters, use_numbers, use_special_characters, user_ttl].hash
    end
