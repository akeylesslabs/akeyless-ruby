...
module Akeyless
  ...
  class DynamicSecretCreateVenafi
    ...
    def hash
      [admin_rotation_interval_days, allow_subdomains, allowed_domains, ara_enabled, auto_generated_folder, delete_protection, description, enable_admin_rotation, input_rule, item_custom_fields, json, name, output_rule, producer_encryption_key_name, root_first_in_chain, sign_using_akeyless_pki, signer_key_name, skip_dry_run, store_private_key, tags, target_name, token, uid_token, user_ttl, venafi_access_token, venafi_api_key, venafi_baseurl, venafi_client_id, venafi_refresh_token, venafi_use_tpp, venafi_zone].hash
    end
