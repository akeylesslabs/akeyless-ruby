...
module Akeyless
  ...
  class DynamicSecretCreateAerospike
    ...
    def hash
      [aerospike_roles, ara_enabled, custom_username_template, delete_protection, description, input_rule, item_custom_fields, json, name, output_rule, password_length, skip_dry_run, target_name, token, uid_token, use_capital_letters, use_lower_letters, use_numbers, use_special_characters, user_ttl].hash
    end
