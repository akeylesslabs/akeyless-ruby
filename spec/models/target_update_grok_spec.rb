...
# Unit tests for Akeyless::TargetUpdateGrok
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::TargetUpdateGrok do
  let(:instance) { Akeyless::TargetUpdateGrok.new }

  describe 'test an instance of TargetUpdateGrok' do
    it 'should create an instance of TargetUpdateGrok' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::TargetUpdateGrok)
    end
  end
