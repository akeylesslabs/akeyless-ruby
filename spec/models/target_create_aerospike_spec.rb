...
# Unit tests for Akeyless::TargetCreateAerospike
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::TargetCreateAerospike do
  let(:instance) { Akeyless::TargetCreateAerospike.new }

  describe 'test an instance of TargetCreateAerospike' do
    it 'should create an instance of TargetCreateAerospike' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::TargetCreateAerospike)
    end
  end
