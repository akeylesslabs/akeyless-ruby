...
# Unit tests for Akeyless::DynamicSecretUpdateAerospike
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::DynamicSecretUpdateAerospike do
  let(:instance) { Akeyless::DynamicSecretUpdateAerospike.new }

  describe 'test an instance of DynamicSecretUpdateAerospike' do
    it 'should create an instance of DynamicSecretUpdateAerospike' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::DynamicSecretUpdateAerospike)
    end
  end
