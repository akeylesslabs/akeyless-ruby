...
# Unit tests for Akeyless::TargetUpdateBedrock
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::TargetUpdateBedrock do
  let(:instance) { Akeyless::TargetUpdateBedrock.new }

  describe 'test an instance of TargetUpdateBedrock' do
    it 'should create an instance of TargetUpdateBedrock' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::TargetUpdateBedrock)
    end
  end
