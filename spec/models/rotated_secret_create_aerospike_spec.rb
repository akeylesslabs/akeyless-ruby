...
# Unit tests for Akeyless::RotatedSecretCreateAerospike
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretCreateAerospike do
  let(:instance) { Akeyless::RotatedSecretCreateAerospike.new }

  describe 'test an instance of RotatedSecretCreateAerospike' do
    it 'should create an instance of RotatedSecretCreateAerospike' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretCreateAerospike)
    end
  end
