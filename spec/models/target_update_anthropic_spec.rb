...
# Unit tests for Akeyless::TargetUpdateAnthropic
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::TargetUpdateAnthropic do
  let(:instance) { Akeyless::TargetUpdateAnthropic.new }

  describe 'test an instance of TargetUpdateAnthropic' do
    it 'should create an instance of TargetUpdateAnthropic' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::TargetUpdateAnthropic)
    end
  end
