...
# Unit tests for Akeyless::TargetCreateGoogleTrust
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::TargetCreateGoogleTrust do
  let(:instance) { Akeyless::TargetCreateGoogleTrust.new }

  describe 'test an instance of TargetCreateGoogleTrust' do
    it 'should create an instance of TargetCreateGoogleTrust' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::TargetCreateGoogleTrust)
    end
  end
