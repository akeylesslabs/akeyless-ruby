...
# Unit tests for Akeyless::RotatedSecretCreateF5BigIp
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::RotatedSecretCreateF5BigIp do
  let(:instance) { Akeyless::RotatedSecretCreateF5BigIp.new }

  describe 'test an instance of RotatedSecretCreateF5BigIp' do
    it 'should create an instance of RotatedSecretCreateF5BigIp' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::RotatedSecretCreateF5BigIp)
    end
  end
