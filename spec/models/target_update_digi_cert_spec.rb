...
# Unit tests for Akeyless::TargetUpdateDigiCert
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::TargetUpdateDigiCert do
  let(:instance) { Akeyless::TargetUpdateDigiCert.new }

  describe 'test an instance of TargetUpdateDigiCert' do
    it 'should create an instance of TargetUpdateDigiCert' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::TargetUpdateDigiCert)
    end
  end
