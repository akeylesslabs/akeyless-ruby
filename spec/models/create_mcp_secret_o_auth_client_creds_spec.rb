...
# Unit tests for Akeyless::CreateMcpSecretOAuthClientCreds
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::CreateMcpSecretOAuthClientCreds do
  let(:instance) { Akeyless::CreateMcpSecretOAuthClientCreds.new }

  describe 'test an instance of CreateMcpSecretOAuthClientCreds' do
    it 'should create an instance of CreateMcpSecretOAuthClientCreds' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::CreateMcpSecretOAuthClientCreds)
    end
  end
