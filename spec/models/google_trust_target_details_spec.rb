...
# Unit tests for Akeyless::GoogleTrustTargetDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::GoogleTrustTargetDetails do
  let(:instance) { Akeyless::GoogleTrustTargetDetails.new }

  describe 'test an instance of GoogleTrustTargetDetails' do
    it 'should create an instance of GoogleTrustTargetDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Akeyless::GoogleTrustTargetDetails)
    end
  end
