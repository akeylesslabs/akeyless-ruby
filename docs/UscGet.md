...
| ---- | ---- | ----------- | ----- |
| **gcp_project_id** | **String** | The GCP project the secret resides in (GCP only). Used when getting a secret by name in a connector that spans multiple projects or uses folder/organization scope. | [optional] |
